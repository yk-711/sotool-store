...
function accountRedirectUrl(_req) {
  // Keep the redirect on the same origin that set the auth cookie.
  // Using FRONTEND_URL here can break authentication when the frontend
  // and backend are on different origins because the httpOnly cookie belongs
